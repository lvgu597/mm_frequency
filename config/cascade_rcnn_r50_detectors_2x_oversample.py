...
data = dict(
    ...
    train=dict(
        ...
        oversample_thr=3,  #进行oversample操作
        dataset = dict(
            type=dataset_type,
...
work_dir = '../data/work_dirs/cascade_rcnn_r50_detectors_2x_oversample'
load_from = '../data/work_dirs/cascade_rcnn_r50_detectors_70e/epoch_30.pth' #加载预训练网络参数
