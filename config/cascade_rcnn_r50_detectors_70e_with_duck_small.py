_base_ = './cascade_rcnn_r50_detectors_70e.py'
# dataset settings
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/Duck_inject_normal_small.json',
...
log_level = 'INFO'
work_dir = '../data/work_dirs/cascade_rcnn_r50_detectors_70e_with_duck_small.py'
load_from = '../data/work_dirs/cascade_rcnn_r50_detectors_70e/epoch_59.pth' #加载预训练网络参数
resume_from = None
workflow = [('train', 1)]