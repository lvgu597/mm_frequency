...
data = dict(
    ...
    train=dict(
        ...
        img_prefix=data_root + 'train_image_low_1440_crop/',
...
log_level = 'INFO'
work_dir = '../data/work_dirs/faster_rcnn_r50_fpn_2x_freqnet_l1440_crop'
load_from = '../data/pretrained/fcanet_faster_rcnn50.pth' #加载预训练网络参数
resume_from = None
workflow = [('train', 1)]