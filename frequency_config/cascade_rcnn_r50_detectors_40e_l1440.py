_base_ = '../config/cascade_rcnn_r50_detectors_70e.py'
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=[(3400, 800), (3400, 1200)], #最大test scale
        flip=True, #测试时是否翻转图片
        transforms=[
...
data = dict(
    ...
    train=dict(
        ...
        img_prefix=data_root + 'train_image_low_1440/',
...
work_dir = '../data/work_dirs/cascade_rcnn_r50_detectors_40e_l1440'